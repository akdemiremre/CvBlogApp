...
namespace CvBlog.Data.Concrete.EntityFramework.Mappings
{
    public class UserMap : IEntityTypeConfiguration<User>
    {
        public void Configure(EntityTypeBuilder<User> builder)
        {
            ...
            builder.HasIndex(u => u.Email).IsUnique(); // HasIndex => Bir indexi var mı ? varsa seç diyor. u.Email i seçip uniqe olarak belirttik. Yani aynı mailden 2 tane olamayacak.
