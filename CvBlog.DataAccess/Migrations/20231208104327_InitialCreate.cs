    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7306), true, false, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7307), "beginner", "CompetencyLevel(beginner)" },
                    { 2, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7328), true, false, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7328), "elementary", "CompetencyLevel(elementary)" },
                    { 3, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7332), true, false, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7333), "pre-intermediate", "CompetencyLevel(pre-intermediate)" },
                    { 4, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7336), true, false, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7336), "intermediate", "CompetencyLevel(intermediate)" },
                    { 5, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7339), true, false, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7340), "upper-intermediate", "CompetencyLevel(upper-intermediate)" },
                    { 6, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7345), true, false, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7345), "advanced", "CompetencyLevel(advanced)" },
                    { 7, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7349), true, false, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 644, DateTimeKind.Local).AddTicks(7349), "expert-proficency", "CompetencyLevel(expert-proficency)" }
                });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedByName", "CreatedDate", "Description", "IsActive", "IsDeleted", "ModifiedByName", "ModifiedDate", "Name", "Note" },
                values: new object[] { 1, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 646, DateTimeKind.Local).AddTicks(2356), "Admin Rolü, Tüm Haklara Sahiptir.", true, false, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 646, DateTimeKind.Local).AddTicks(2357), "Admin", "Admin Rolüdür." });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 647, DateTimeKind.Local).AddTicks(860), "Sistemin ilk admin kullanıcısı", "info@emreakdemir.net", "Emre", true, false, "Akdemir", "InitialCreate", new DateTime(2023, 12, 8, 13, 43, 27, 647, DateTimeKind.Local).AddTicks(861), "Admin Kullanıcısı", new byte[] { 48, 49, 57, 50, 48, 50, 51, 97, 55, 98, 98, 100, 55, 51, 50, 53, 48, 53, 49, 54, 102, 48, 54, 57, 100, 102, 49, 56, 98, 53, 48, 48 }, "default.jpg", 1, "info@emreakdemir.net" });
